...
const Project = () => {
  return (
    <div className="pb-4 border-b border-neutral-900">
        ...
        className="my-20 text-4xl text-center">Project</motion.h1>
        <div>
                ...
                transition={{duration:1}}
                 className="w-full max-w-xl lg:w-3/4">
                    ...
                    {Project.tools.map((tech,index)=>(
                        <span key={index} className="px-2 py-1 mr-2 text-sm font-medium text-red-500 rounded bg-neutral-900">{tech}</span>
                    ))}
                </motion.div>
                </div>
            ))}
